...
const MENUS: Record<"admin" | "user" | "restricted", MenuRole> = {
  admin: {
    commands: [
      ...
      { command: "dashboard", description: "Your dashboard" },
      ...
      { command: "referrals", description: "Referral leaderboard" },
      { command: "promote", description: "Make someone an admin (id)" },
      { command: "demote", description: "Remove someone's admin (id)" },
